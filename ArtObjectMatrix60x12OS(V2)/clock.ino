...
void setModeByModeId(byte saveThisMode) {
  ...
  if (saveRunningFlag) {
    ...
    if (tmp <= MAX_EFFECT) {
      ...
      } else if (saveThisMode == DEMO_TEXT_0 || saveThisMode == DEMO_TEXT_1 || saveThisMode == DEMO_TEXT_2 || saveThisMode == DEMO_TEXT_3 || saveThisMode == DEMO_TEXT_4 || saveThisMode == DEMO_TEXT_5 || saveThisMode == DEMO_TEXT_6 || saveThisMode == DEMO_TEXT_7 || saveThisMode == DEMO_TEXT_8 || saveThisMode == DEMO_TEXT_9 || saveThisMode == DEMO_TEXT_10 || saveThisMode == DEMO_TEXT_11 || saveThisMode == DEMO_TEXT_12 || saveThisMode == DEMO_TEXT_13) {
        thisMode = saveThisMode;
        loadingFlag = true;
      }
    }
