...
void bluetoothRoutine() {  
  ...
  if (tmpSaveMode != thisMode) {
    ...
    if (thisMode == DEMO_TEXT_0 || thisMode == DEMO_TEXT_1 || thisMode == DEMO_TEXT_2 || thisMode == DEMO_TEXT_3 || thisMode == DEMO_TEXT_4 || thisMode == DEMO_TEXT_5 || thisMode == DEMO_TEXT_6 || thisMode == DEMO_TEXT_7 || thisMode == DEMO_TEXT_8 || thisMode == DEMO_TEXT_9 || thisMode == DEMO_TEXT_10 || thisMode == DEMO_TEXT_11 || thisMode == DEMO_TEXT_12 || thisMode == DEMO_TEXT_13) {
      // Это бегущий текст  
    ...
    switch (intData[0]) {
      ...
      case 16:
        ...
        if (!BTcontrol) {
          ...
          if (intData[1] == 0 || (intData[1] == 1 && (thisMode == DEMO_TEXT_0 || thisMode == DEMO_TEXT_1 || thisMode == DEMO_TEXT_2 || thisMode == DEMO_TEXT_3 || thisMode == DEMO_TEXT_4 || thisMode == DEMO_TEXT_5 || thisMode == DEMO_TEXT_6 || thisMode == DEMO_TEXT_7 || thisMode == DEMO_TEXT_8 || thisMode == DEMO_TEXT_9 ))) {
            loadingFlag = true;
            runningFlag = true;          
          }
        }
