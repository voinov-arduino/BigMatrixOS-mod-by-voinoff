...
void customRoutine() {
  ...
  if (!gamemodeFlag || isAlarming) {
    ...
    if (!isAlarming && (thisMode == DEMO_TEXT_0 || thisMode == DEMO_TEXT_1 || thisMode == DEMO_TEXT_2  || thisMode == DEMO_TEXT_3 || thisMode == DEMO_TEXT_4 || thisMode == DEMO_TEXT_5 || thisMode == DEMO_TEXT_6 || thisMode == DEMO_TEXT_7 || thisMode == DEMO_TEXT_8 || thisMode == DEMO_TEXT_9 || thisMode == DEMO_TEXT_10 || thisMode == DEMO_TEXT_11 || thisMode == DEMO_TEXT_12 || thisMode == DEMO_TEXT_13)) {
...
void customModes(byte aMode) {
  ...
  switch (aMode) {    
    ...
    case DEMO_TEXT_2: 
      ...
      break;
    case DEMO_TEXT_3:
      text = runningText == "" ? TEXT_4 : runningText;
      fillString(text, 1);
      break;
    case DEMO_TEXT_4:
      text = runningText == "" ? TEXT_5 : runningText;
      fillString(text,1);
      break;
    case DEMO_TEXT_5:
      text = runningText == "" ? TEXT_6 : runningText;
      fillString(text,1);
      break;
    case DEMO_TEXT_6:
      text = runningText == "" ? TEXT_7 : runningText;
      fillString(text,1);
      break;
    case DEMO_TEXT_7:
      text = runningText == "" ? TEXT_8 : runningText;
      fillString(text,1);
      break;
    case DEMO_TEXT_8:
      text = runningText == "" ? TEXT_9 : runningText;
      fillString(text,1);
      break;
    case DEMO_TEXT_9:
      text = runningText == "" ? TEXT_10 : runningText;
      fillString(text,1);
      break;
    case DEMO_TEXT_10:
      text = runningText == "" ? TEXT_11 : runningText;
      fillString(text,1);
      break;
    case DEMO_TEXT_11:
      text = runningText == "" ? TEXT_12 : runningText;
      fillString(text,1);
      break;
    case DEMO_TEXT_12:
      text = runningText == "" ? TEXT_13 : runningText;
      fillString(text,1);
      break;
    case DEMO_TEXT_13:
      text = runningText == "" ? TEXT_14 : runningText;
      fillString(text,1);
      break;
...
void setTimersForMode(byte aMode) {
  if (aMode == DEMO_TEXT_0 || aMode == DEMO_TEXT_1 || aMode == DEMO_TEXT_2 || aMode == DEMO_TEXT_3 || aMode == DEMO_TEXT_4 || aMode == DEMO_TEXT_5 || aMode == DEMO_TEXT_6 || aMode == DEMO_TEXT_7 || aMode == DEMO_TEXT_8 || aMode == DEMO_TEXT_9 || aMode == DEMO_TEXT_10 || aMode == DEMO_TEXT_11 || aMode == DEMO_TEXT_12 || aMode == DEMO_TEXT_13) {
    // Это бегущий текст  
...
byte mapModeToEffect(byte aMode) {
  ...
  switch (aMode) {
    ...
    case DEMO_TEXT_3 :  break;      // Бегущий текст
    case DEMO_TEXT_4 :  break;      // Бегущий текст
    case DEMO_TEXT_5 :  break;      // Бегущий текст
    case DEMO_TEXT_6 :  break;      // Бегущий текст
    case DEMO_TEXT_7 :  break;      // Бегущий текст
    case DEMO_TEXT_8 :  break;      // Бегущий текст
    case DEMO_TEXT_9 :  break;      // Бегущий текст
    case DEMO_TEXT_10 :  break;     // Бегущий текст
    case DEMO_TEXT_11 :  break;     // Бегущий текст
    case DEMO_TEXT_12 :  break;     // Бегущий текст
    case DEMO_TEXT_13 :  break;     // Бегущий текст
